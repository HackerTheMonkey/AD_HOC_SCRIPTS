...
rexec p630_app1 echo "------------------------------"
rexec p630_app1 echo "Checking the java processes"
rexec p630_app1 ps auwx|grep java|grep medcdr|grep -v grep|wc -l>no.java 
read java_no<no.java
echo "The number of running java processes are $java_no"
rexec p630_app1 echo "------------------------------"
rexec p630_app1 ps auwx|grep java|grep medcdr|grep -v grep 
rexec p630_app1 echo "------------------------------"
rm -fr no.proc
rm -fr no.java
rm -fr no.pre
